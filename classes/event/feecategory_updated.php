 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class feecategory_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('updatefeecategory', 'local_feeheadmanagement');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the fee category with id '$this->objectid'.";
    }
